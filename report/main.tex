...
Speech is a time-domain waveform, but many phonetic cues become much clearer after short-time spectral analysis. Sampling, Fourier analysis, and local spectra make physically meaningful structure visible. This work uses those tools as part of a controlled comparison of detectors for deciding whether selected voiced consonants are present in spoken isolated words.
